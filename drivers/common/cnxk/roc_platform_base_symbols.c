...
RTE_EXPORT_INTERNAL_SYMBOL(roc_idev_ml_get)
RTE_EXPORT_INTERNAL_SYMBOL(roc_idev_ml_set)
...
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_pf_func_get)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_is_pf)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_get_pf)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_get_vf)
...
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_lf_reg_read64)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_lf_reg_write64)
...
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_jcmdq_enqueue_nolock)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_jcmdq_enqueue_splock)
...
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_num_engines_get)
...
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_dev_configure)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_dev_close)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_lf_init)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_lf_fini)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_pid_lf_map)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_sso_pf_func_get)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_lf_jcmdq_enqueue_nolock)
RTE_EXPORT_INTERNAL_SYMBOL(roc_ml_lf_jcmdq_enqueue_splock)
