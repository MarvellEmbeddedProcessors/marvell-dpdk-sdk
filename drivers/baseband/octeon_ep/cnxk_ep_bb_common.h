...
#define cnxk_ep_bb_info(...) \
	RTE_LOG_LINE_PREFIX(INFO, OCTEON_EP_BBDEV, "%s():%u ", \
		__func__ RTE_LOG_COMMA __LINE__, __VA_ARGS__)

#define cnxk_ep_bb_err(...) \
	RTE_LOG_LINE_PREFIX(ERR, OCTEON_EP_BBDEV, "%s():%u ", \
		__func__ RTE_LOG_COMMA __LINE__, __VA_ARGS__)

#define cnxk_ep_bb_dbg(...) \
	RTE_LOG_LINE_PREFIX(DEBUG, OCTEON_EP_BBDEV, "%s():%u ", \
		__func__ RTE_LOG_COMMA __LINE__, __VA_ARGS__)
...
#define RTE_LOGTYPE_OCTEON_EP_BBDEV octeon_ep_bbdev_logtype
