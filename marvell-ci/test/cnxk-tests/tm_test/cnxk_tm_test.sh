...
function verify_case_4()
{
	...
	do
		...
		q6=`queue_stats 7`
		q7=`queue_stats 8`
		q116=$((q1*16*percentage/100))
	        q164=$((q1*64*percentage/100))
		q1255=$((q1*255*percentage/100))
		q11=$((q1*percentage/100))
		#This case is to verify scaling of queue count, queue0 count
	        #with very few packets (QCNT_DOWN) will be considered as success
		if [[ $q0 -lt $QCNT_DOWN && $q6 -lt $QCNT_DOWN &&
		       	$q7 -lt $QCNT_DOWN && $q1 -gt $QCNT_DOWN &&
		       	$q2 -gt $q116 && $q3 -gt $q164 && $q4 -gt $q1255 &&
		       	$q5 -gt $q11 ]]
		then
...
function verify_case_6()
{
	...
	do
		...
		q6=`queue_stats 7`
		q7=`queue_stats 8`
		q63=$((q6*3*percentage/100))
		if [[ $q0 -lt $QCNT_DOWN && $q1 -lt $QCNT_DOWN &&
		       	$q2 -lt $QCNT_DOWN && $q3 -lt $QCNT_DOWN &&
		       	$q4 -lt $QCNT_DOWN && $q5 -lt $QCNT_DOWN &&
		       	$q6 -gt $QCNT_UP && $q7 -gt $q63 ]]
		then
...
testpmd_cmd $CAP_PRFX "add port tm nonleaf node 0 301 200 1 0 1 1000 1 0 0"
