...
/** AES-256-CBC HMAC-SHA1 test vector */
static const struct blockcipher_test_data aes_test_data_11 = {
	...
	.digest = {
		.data = {
			0x42, 0xCD, 0xE0, 0xC8, 0x3C, 0xD3, 0xD9, 0xF0,
			0xE9, 0x48, 0xAB, 0xD3, 0xEF, 0x75, 0x37, 0x62,
			0x59, 0xB5, 0x59, 0x9E
		},
		.len = 20,
	}
...
/** AES-192-CBC HMAC-SHA1 test vector */
static const struct blockcipher_test_data aes_test_data_22 = {
	.crypto_algo = RTE_CRYPTO_CIPHER_AES_CBC,
	.cipher_key = {
		.data = {
			0xE4, 0x23, 0x33, 0x8A, 0x35, 0x64, 0x61, 0xE2,
	...
	.digest = {
		.data = {
			0x58, 0x50, 0xFE, 0x44, 0xCF, 0x74, 0xD3, 0x61,
			0x9B, 0xD7, 0xB8, 0x9B, 0x9E, 0xC4, 0x78, 0x3C,
			0xEC, 0x34, 0x28, 0x3B
		},
		.len = 20,
	}
...
/** AES-192-CBC HMAC-SHA256 test vector */
static const struct blockcipher_test_data aes_test_data_23 = {
	.crypto_algo = RTE_CRYPTO_CIPHER_AES_CBC,
	.cipher_key = {
		.data = {
			0xE4, 0x23, 0x33, 0x8A, 0x35, 0x64, 0x61, 0xE2,
	...
	.digest = {
		.data = {
			0x0C, 0x69, 0x4D, 0x6B, 0x53, 0xE0, 0x0F, 0xBD,
			0x25, 0xAC, 0xEA, 0x53, 0x25, 0xEB, 0x19, 0x63,
			0xAD, 0x4F, 0x1E, 0x4B, 0x28, 0x00, 0x94, 0x1F,
			0xE3, 0x64, 0xB1, 0x11, 0xFC, 0xED, 0x37, 0x69,
		},
		.len = 32,
	}
};

/** AES-256-CBC HMAC-SHA256 test vector */
static const struct blockcipher_test_data aes_test_data_24 = {
	.crypto_algo = RTE_CRYPTO_CIPHER_AES_CBC,
	.cipher_key = {
		.data = {
			0xE4, 0x23, 0x33, 0x8A, 0x35, 0x64, 0x61, 0xE2,
	...
	.digest = {
		.data = {
			0xB5, 0x2D, 0x69, 0x84, 0xAB, 0x0C, 0x98, 0xCF,
			0xB6, 0x24, 0xA7, 0xED, 0x98, 0xB5, 0x2A, 0x8B,
			0xC0, 0xD4, 0xC7, 0xD8, 0x6F, 0x43, 0xDD, 0x3C,
			0xC8, 0xF8, 0x98, 0x9E, 0xE1, 0xBE, 0x41, 0x44
		},
		.len = 32,
	}
};

/** AES-192-CBC HMAC-SHA512 test vector */
static const struct blockcipher_test_data aes_test_data_25 = {
	.crypto_algo = RTE_CRYPTO_CIPHER_AES_CBC,
	.cipher_key = {
		.data = {
			0xE4, 0x23, 0x33, 0x8A, 0x35, 0x64, 0x61, 0xE2,
	...
	.digest = {
		.data = {
			0x50, 0x4E, 0xB2, 0x1C, 0x08, 0x10, 0x0C, 0x7D,
			0x4A, 0xEA, 0xD9, 0x07, 0xBB, 0xFC, 0x1A, 0x4D,
			0xD2, 0x1F, 0xA9, 0xD4, 0xE5, 0x24, 0xC4, 0x83,
			0xD5, 0x9B, 0xEF, 0x80, 0xB4, 0x99, 0x23, 0x00,
			0x47, 0xF0, 0xD0, 0x27, 0x93, 0x50, 0x6F, 0xEE,
			0x2F, 0xA1, 0xE7, 0xDE, 0x0F, 0xCF, 0x66, 0xBC,
			0x6C, 0x19, 0xDE, 0x7E, 0xA4, 0xE7, 0x30, 0x8E,
			0xC2, 0x6C, 0x60, 0xF9, 0xE0, 0x05, 0x7E, 0xA5
		},
		.len = 64,
	}
};

/** AES-256-CBC HMAC-SHA512 test vector */
static const struct blockcipher_test_data aes_test_data_26 = {
	.crypto_algo = RTE_CRYPTO_CIPHER_AES_CBC,
	.cipher_key = {
		.data = {
			0xE4, 0x23, 0x33, 0x8A, 0x35, 0x64, 0x61, 0xE2,
	...
	.digest = {
		.data = {
			0x72, 0x70, 0xD3, 0xDD, 0xF6, 0x86, 0x33, 0xBE,
			0x8C, 0xD6, 0x44, 0x74, 0xED, 0xFC, 0x89, 0x33,
			0x33, 0x34, 0x34, 0x2F, 0x5E, 0x94, 0xB9, 0x2C,
			0xD2, 0x5D, 0xC7, 0x93, 0xEE, 0x54, 0xB0, 0x6E,
			0xCF, 0xA8, 0x72, 0xC5, 0x37, 0xA2, 0x30, 0x43,
			0xE5, 0xAC, 0xF0, 0x2A, 0x8A, 0x04, 0xAF, 0x8B,
			0xC6, 0x6B, 0xC8, 0xB8, 0x19, 0x26, 0x8E, 0x77,
			0x37, 0xD8, 0x48, 0x66, 0x67, 0x59, 0xA2, 0x2C
		},
		.len = 64,
	}
};
...
static const struct blockcipher_test_case aes_chain_test_cases[] = {
	...
	{
		.test_descr = "AES-192-CBC HMAC-SHA256 Encryption Digest",
		.test_data = &aes_test_data_23,
		.op_mask = BLOCKCIPHER_TEST_OP_ENC_AUTH_GEN,
	},
	{
		.test_descr = "AES-192-CBC HMAC-SHA256 Decryption Digest "
			"Verify",
		.test_data = &aes_test_data_23,
		.op_mask = BLOCKCIPHER_TEST_OP_AUTH_VERIFY_DEC,
	},
	{
		.test_descr = "AES-256-CBC HMAC-SHA256 Encryption Digest",
		.test_data = &aes_test_data_24,
		.op_mask = BLOCKCIPHER_TEST_OP_ENC_AUTH_GEN,
	},
	{
		.test_descr = "AES-256-CBC HMAC-SHA256 Decryption Digest "
			"Verify",
		.test_data = &aes_test_data_24,
		.op_mask = BLOCKCIPHER_TEST_OP_AUTH_VERIFY_DEC,
	},
	{
		.test_descr = "AES-192-CBC HMAC-SHA512 Encryption Digest",
		.test_data = &aes_test_data_25,
		.op_mask = BLOCKCIPHER_TEST_OP_ENC_AUTH_GEN,
	},
	{
		.test_descr = "AES-192-CBC HMAC-SHA512 Decryption Digest "
			"Verify",
		.test_data = &aes_test_data_25,
		.op_mask = BLOCKCIPHER_TEST_OP_AUTH_VERIFY_DEC,
	},
	{
		.test_descr = "AES-256-CBC HMAC-SHA512 Encryption Digest",
		.test_data = &aes_test_data_26,
		.op_mask = BLOCKCIPHER_TEST_OP_ENC_AUTH_GEN,
	},
	{
		.test_descr = "AES-256-CBC HMAC-SHA512 Decryption Digest "
			"Verify",
		.test_data = &aes_test_data_26,
		.op_mask = BLOCKCIPHER_TEST_OP_AUTH_VERIFY_DEC,
	},
